            ...
            <div className="bg-white p-8 md:p-12 rounded-app-xl border border-neutral-100 shadow-sm space-y-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                        <div className="space-y-2">
                            <div className="flex items-center gap-2 ml-1">
                                ...
                                <Typography variant={TypographyVariant.OVERLINE} className="text-neutral-400">Código Interno (SKU)</Typography>
                            </div>
                            <input
                                type="text"
                                value={form.sku}
                ...
                <section className="space-y-6 pt-8 border-t border-neutral-50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                        <div className="space-y-2">
                            <Typography variant={TypographyVariant.OVERLINE} className="ml-1 text-neutral-400">Cantidad Inicial</Typography>
                            <input
                                type="number"
